 ...
 */
public class ConsultaInventarioBO {
    ...
    public List<Producto> buscarProductosFiltros(String nombreProducto, String precioFiltro, String stockFiltro, String ordenFiltro) throws ExcepcionAT {
    ProductoDAO dao = new ProductoDAO();
    return dao.buscarProductosConFiltros(nombreProducto, precioFiltro, stockFiltro, ordenFiltro);
}
}